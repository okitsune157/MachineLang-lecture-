...
public class RunModeFactory extends Factory<Integer, RunMode> {
	...
	public RunModeFactory() {
		...
		makeItem(Integer.valueOf(RM_NORMAL), new NormalMode());
		makeItem(Integer.valueOf(RM_CLOCK),  new ClockStepMode());
		makeItem(Integer.valueOf(RM_INST),   new InstructionStepMode());
	}
