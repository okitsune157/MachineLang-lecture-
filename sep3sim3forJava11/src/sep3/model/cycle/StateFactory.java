...
public class StateFactory extends Factory<Integer, State> {
	...
	public StateFactory() {
		...
		makeItem(Integer.valueOf(SC_IF0), new InstFetchState0());
		makeItem(Integer.valueOf(SC_IF1), new InstFetchState1());
		makeItem(Integer.valueOf(SC_FF0), new FromFetchState0());
		makeItem(Integer.valueOf(SC_FF1), new FromFetchState1());
		makeItem(Integer.valueOf(SC_FF2), new FromFetchState2());
		makeItem(Integer.valueOf(SC_TF0), new ToFetchState0());
		makeItem(Integer.valueOf(SC_TF1), new ToFetchState1());
		makeItem(Integer.valueOf(SC_EX0), new ExecState0());
		makeItem(Integer.valueOf(SC_EX1), new ExecState1());
		makeItem(Integer.valueOf(SC_HLT), new HaltState());
		makeItem(Integer.valueOf(SC_ILL), new IllState());
	}
