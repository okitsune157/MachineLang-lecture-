...
public class Model {
	...
	public void powerOn() {
		...
		cpu.powerOn();
		reset();
//		mem.setValue(0x300, 0xf0f0);
//		mem.setValue(0x301, 0x43e6);
//		mem.setValue(0x302, 0x0300);
//		mem.setValue(0x303, 0x40c0);
//		mem.setValue(0x304, 0x0000);
		cpu.getRegister(CPU.REG_PC).setInitValue(0x200);
	}
