...
public class LabeledLED7segment extends JPanel {
	...
	public LabeledLED7segment(String label, int labelPt, String pos) { this(label, labelPt, pos, 40); }	// LEDの表示はデフォルト40pt
	public LabeledLED7segment(String label, String pos) { this(label,  18, pos); }	// デフォルトのラベルフォントの大きさptは18
	public LabeledLED7segment(String label) { this(label, 18, "South"); }			// デフォルトの位置は、ボタンの下
